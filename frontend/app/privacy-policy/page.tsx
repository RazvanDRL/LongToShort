        ...
        <>
            ...
            <div className="mt-16 max-w-4xl mx-auto px-4 py-8">
                ...
                <ul className="list-disc pl-6 mb-6">
                    ...
                    <li className="mb-2">
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to DRL IT SOLUTIONS S.R.L., Sever Bocu 4.</p>
                    </li>
                    <li className="mb-2">
                    ...
                    <li className="mb-2">
                        <p><strong>Website</strong> refers to AutoSubs, accessible from <a href="https://autosubs.io" rel="external nofollow noopener" target="_blank" className="text-blue-600 hover:underline">https://autosubs.io</a></p>
                    </li>
                    <li className="mb-2">
                ...
                <h4 className="text-lg font-semibold mt-4 mb-2">Information from Third-Party Social Media Services</h4>
                ...
                <ul className="list-disc pl-6 mb-6">
                    <li className="mb-2"><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</li>
                    <li className="mb-2"><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</li>
                </ul>
                ...
                <ul className="list-disc pl-6 mb-6">
                    <li>By visiting this page on our website: <a href="https://autosubs.io/contact" rel="external nofollow noopener" target="_blank" className="text-blue-600 hover:underline">https://autosubs.io/contact</a></li>
                </ul>
            </div>
        </>
    );
